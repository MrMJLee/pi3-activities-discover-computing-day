...
Description: A program runs on the Raspberry Pi 3 to draw the Christmas tree on the Sense HAT led matrix.

Tasks 3:
    Modify the program to make the decorations randomly change their colours every half a second.
    This simulates Christmas tree lights.
    Add your code for this task in the main() function.
    NB: In this task make use of the functions that are provided in this program.
'''
...
def main():
    ...
    # Start adding your code for Tasks 3 from here
