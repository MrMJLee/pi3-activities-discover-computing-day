...
Task 1: Prepare for next tasks
    a. Run this program and observe the Xmas tree on the LED matrix;
    b. Study to understand the code - ask if there is anything you do not understand;
    c. Once you are ready, proceed to Task 2.

'''

from sense_hat import SenseHat # Required for communicating with the Sense HAT
import time # Required to allow displaying objects for specified amount of time
import random as rand # Required for randomly picking colours
...
def main():
    ...
    # Draw the undocorated Christmas Tree
    drawTree(undecorated_tree)

    # Wait 8 sec --> displays the tree for 8 sec
    time.sleep(8) 

    # Clear the LED matrix --> erases the tree from the LED matrix
    sense.clear()
